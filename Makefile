# This Makefile is for the simpleDancer extension to perl.
#
...
#     NAME => q[simpleDancer]
#     PL_FILES => {  }
#     PREREQ_PM => { Test::More=>q[0], YAML=>q[0], Plack=>q[0], Dancer=>q[1.307], Plack::Request=>q[0] }
#     VERSION_FROM => q[lib/simpleDancer.pm]
#     clean => { FILES=>q[simpleDancer-*] }
...
MAKE = make
FULLEXT = simpleDancer
BASEEXT = simpleDancer
PARENT_NAME = 
DLBASE = $(BASEEXT)
...
TO_INST_PM = lib/simpleDancer.pm

PM_TO_BLIB = lib/simpleDancer.pm \
	blib/lib/simpleDancer.pm
...
DISTNAME = simpleDancer
DISTVNAME = simpleDancer-0.1
...
metafile : create_distdir
	...
	$(NOECHO) $(ECHO) 'name:               simpleDancer' >> META_new.yml
	...
	$(NOECHO) $(ECHO) '    Dancer:          1.307' >> META_new.yml
...
ppd :
	...
	$(NOECHO) $(ECHO) '        <REQUIRE NAME="Dancer::" VERSION="1.307" />' >> $(DISTNAME).ppd
...
pm_to_blib : $(FIRST_MAKEFILE) $(TO_INST_PM)
	$(NOECHO) $(ABSPERLRUN) -MExtUtils::Install -e 'pm_to_blib({@ARGV}, '\''$(INST_LIB)/auto'\'', q[$(PM_FILTER)], '\''$(PERM_DIR)'\'')' -- \
	  lib/simpleDancer.pm blib/lib/simpleDancer.pm 
